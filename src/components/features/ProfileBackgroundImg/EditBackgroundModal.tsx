            ...
            {croppedImageUrl ? (
              <div className={styles.editBackgroundModal__preview}>
                ...
                <button
                  ...
                  className={styles.editBackgroundModal__editButton}
                >
                  Edytuj ponownie
                </button>
              </div>
              ...
              <div className={styles.editBackgroundModal__importLayout}>
                ...
                <div
                  className={styles.editBackgroundModal__importLayout__grabText}
                >
                  Przeciągnij i upuść plik tutaj aby dodać
                </div>
                <div
                  className={
                    styles.editBackgroundModal__importLayout__dividerContainer
                  }
                >
                  <hr
                    className={
                      styles.editBackgroundModal__importLayout__dividerContainer__line
                    }
                  />
                  <span
                    className={
                      styles.editBackgroundModal__importLayout__dividerContainer__orText
                    }
                  >
                    lub
                  </span>
                ...
                <label
                  htmlFor="fileInput"
                  className={
                    styles.editBackgroundModal__importLayout__fileButton
                  }
                >
                  Wybierz z dysku
                </label>

...
import IncomeGoalItem from "../../items/IncomeGoalItem/IncomeGoalitem.tsx";
...
const IncomeGoalStep: React.FC<IIncomeGoalStepProps> = ({onNext, userGoal}) => {
	...
	const {getIncomeGoals, patchIncomeGoal, loadingStatus, errorMessage} = useOnboardingService();

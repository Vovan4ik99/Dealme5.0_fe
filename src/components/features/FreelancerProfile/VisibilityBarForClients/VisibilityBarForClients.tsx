...
import info from "../../../../assets/icons/freelancerProfile-imgs/uploadImg-imgs/info.svg"

const ProgressBar = ({ progress }: { progress: number }) => {
  return (
    <section className={styles.bar__progressBarContainer}>
      <div className={styles.bar__wrapper}>
        <div className={styles.bar__textContainer}>
          <span className={styles.bar__infoText}>
            Osiągnij wyższy poziom widoczności dla klientów
            <img src={info} alt="Info" />
          </span>
          <span className={styles.bar__percentage}>{progress} / 100%</span>
        </div>
        <div className={styles.bar__progressBar}>
          <div
      ...
      <button className={styles.bar__updateButton}>
        <svg
          width="14"
          height="14"
          viewBox="0 0 14 14"

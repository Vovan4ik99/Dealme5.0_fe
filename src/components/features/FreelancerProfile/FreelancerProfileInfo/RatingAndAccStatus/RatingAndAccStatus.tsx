import styles from "./RatingAndAccStatus.module.scss";
import {
  hourglass,
  dealmeLogo,
  star,
} from "../../../../../assets/icons/freelancerProfile-imgs/visibilityStatus-imgs/visibilityStatusImages";

interface RatingAndAccStatusProps {
  rate: number;
  count: number;
...
const RatingAndAccStatus = ({
  rate,
  count,
  accountStatus,
  visibilityStatus,
}: RatingAndAccStatusProps) => {
  return (
    <>
      <div className={styles.ratingsAndBadges__ratingsWrapper}>
        <span className={styles.ratingsAndBadges__ratingText}>
          <img
            src={star}
            alt="Star"
            className={styles.ratingsAndBadges__starIcon}
          />
          {rate.toFixed(2)}
        </span>
        <span className={styles.ratingsAndBadges__ratingText}>
          <svg
            className={styles.ratingsAndBadges__dealmeIcon}
            width="12"
            height="13"
            viewBox="0 0 12 13"
      ...
      <div className={styles.ratingsAndBadges__badges}>
        {accountStatus === "NORMAL" && (
          <span
            className={styles.ratingsAndBadges__badgeRecommendedIconWithText}
          >
        ...
        {visibilityStatus === "LIMITED" && (
          <span className={styles.ratingsAndBadges__badgeLimitedIconWithText}>
...
export default RatingAndAccStatus;

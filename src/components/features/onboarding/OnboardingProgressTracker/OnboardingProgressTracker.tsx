...
} from "@components/features/onboarding/OnboardingProgressTracker/onboardingProgressTrackerTypes.ts";
import {
	ONBOARDING_PROGRESS_TRACKER_CATEGORIES
} from "@components/features/onboarding/onboardingProgressTrackerCategories.ts";
import {
	CategoryStatus
...
import OnboardingProgressCategory
	from "@components/features/onboarding/OnboardingProgressCategory/OnboardingProgressCategory.tsx";

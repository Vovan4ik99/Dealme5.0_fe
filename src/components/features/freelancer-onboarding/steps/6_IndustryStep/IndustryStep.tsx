...
const IndustryStep: React.FC<IIndustryStepProps> = ({ onNext, userSubIndustries }) => {
	...
	const { loadingStatus, errorMessage, getIndustries, patchSubIndustries } = useFreelancerOnboardingService();
	...
	return (
		<AnimatedStep>
			...
			<IndustryList industries={ industries } selectedSubIndustries={ selectedSubIndustries }
			              onChange={ onChange }/>
